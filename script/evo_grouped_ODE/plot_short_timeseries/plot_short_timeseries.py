...
ax.text(990, 0.93, 'Cooperation Level', fontsize=14, color=cmap(0), ha='right', va='top')
ax.text(990, 0.58, r"L1 with $P(B,B)=D$", fontsize=14, color=cmap(1), ha='right', va='bottom')
ax.text(990, 0.40, "L1", fontsize=14, color=cmap(2), ha='right', va='bottom')
ax.text(990, 0.01, "ALLD", fontsize=14, color=cmap(3), ha='right', va='bottom')
#ax.legend()
...
ax.spines['top'].set_visible(False)
cmap = plt.get_cmap("tab10")
ax.text(990, 0.16, 'Cooperation Level', fontsize=14, color=cmap(0), ha='right', va='top')
ax.text(990, 0.82, "ALLD", fontsize=14, color=cmap(3), ha='right', va='bottom')
ax.text(990, 0.195, "L3", fontsize=14, color=cmap(4), ha='right', va='bottom')
#ax.legend()
# %%
