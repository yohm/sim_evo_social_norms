...
ax.annotate('L1', xy=(1.5, 0.1015), xytext=(15, 0.103), fontsize=14, arrowprops=dict(arrowstyle='-', color='#222222'))
ax.annotate('L2', xy=(10.5, 0.0745), xytext=(24, 0.085), fontsize=14, arrowprops=dict(arrowstyle='-', color='#222222'))
ax.annotate('L7', xy=(31.5, 0.049), xytext=(44, 0.06), fontsize=14, arrowprops=dict(arrowstyle='-', color='#222222'))
ax.annotate('IS', xy=(40.5, 0.026), xytext=(52, 0.04), fontsize=14, arrowprops=dict(arrowstyle='-', color='#222222'))
ax.text(70, 0.025, 'ALLD', fontsize=14, horizontalalignment='center', verticalalignment='center')
...
ax.annotate('L7', xy=(175.5, 0.02), xytext=(150, 0.045), fontsize=14, arrowprops=dict(arrowstyle='-', color='#222222'))
ax.annotate('L4', xy=(178.5, 0.02), xytext=(168, 0.045), fontsize=14, arrowprops=dict(arrowstyle='-', color='#222222'))
ax.annotate('L3', xy=(179.5, 0.02), xytext=(186, 0.045), fontsize=14, arrowprops=dict(arrowstyle='-', color='#222222'))
ax.text(100, 0.035, 'ALLC', fontsize=14, horizontalalignment='center', verticalalignment='center')
...
ax.annotate('L1', xy=(1.5, 0.141), xytext=(50, 0.135), fontsize=14, arrowprops=dict(arrowstyle='-', color='#222222'))
ax.annotate('L7', xy=(3.5, 0.138), xytext=(50, 0.125), fontsize=14, arrowprops=dict(arrowstyle='-', color='#222222'))
ax.annotate('L3', xy=(4.5, 0.126), xytext=(50, 0.11), fontsize=14, arrowprops=dict(arrowstyle='-', color='#222222'))
ax.annotate('L4', xy=(7.5, 0.120), xytext=(50, 0.10), fontsize=14, arrowprops=dict(arrowstyle='-', color='#222222'))
ax.annotate('L5', xy=(36.5, 0.0180), xytext=(65, 0.04), fontsize=14, arrowprops=dict(arrowstyle='-', color='#222222'))
ax.text(100, 0.007, 'ALLC', fontsize=14, horizontalalignment='center', verticalalignment='center')
ax.set_yticks([0, 0.02, 0.04, 0.06, 0.08, 0.10, 0.12, 0.14])
...
#ax.set_ylabel(r"fixation probability, $\rho_{\rm{ALLD} \to X}$", fontsize=16)
ax.annotate('IS', xy=(1, 0.026), xytext=(3, 0.06), fontsize=14, arrowprops=dict(arrowstyle='-', color='#222222'))
ax.annotate('L3', xy=(15, 0.0016), xytext=(20, 0.04), fontsize=14, arrowprops=dict(arrowstyle='-', color='#222222'))
ax.annotate('L6', xy=(17, 0.0), xytext=(24, 0.03), fontsize=14, arrowprops=dict(arrowstyle='-', color='#222222'))
ax.text(8, 0.02, 'ALLD', fontsize=14, horizontalalignment='center', verticalalignment='bottom')
show_norms(norm_ids_s)
